...
public class Edit_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       FButton loadButton = (FButton) findViewById(R.id.loadForEdit);
        ...
        loadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else
                {
                    cr.moveToFirst();
                    try {
                        MaterialEditText name = (MaterialEditText) findViewById(R.id.edit_name_);
                        MaterialEditText roll = (MaterialEditText) findViewById(R.id.roll_);
                        MaterialEditText contact = (MaterialEditText) findViewById(R.id.contact_);
                        assert name != null;
        ...
        FButton saveEdit = (FButton) findViewById(R.id.buttonSAVEEDITS);
