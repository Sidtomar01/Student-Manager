...
public class Student_Registartion extends AppCompatActivity {
    ...
    public void saveToDatabase(View view) {
        MaterialEditText name = (MaterialEditText) findViewById(R.id.edit_name);
        MaterialEditText roll = (MaterialEditText) findViewById(R.id.roll);
        MaterialEditText register = (MaterialEditText) findViewById(R.id.register);
        MaterialEditText contact = (MaterialEditText) findViewById(R.id.contact);
